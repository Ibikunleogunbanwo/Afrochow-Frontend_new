...
export default function Step5() {
  ...
  const saveAndContinue = async (data) => {
    ...
    try {
      ...
      navigateToNextStep("/register/vendor/review");
    } catch (error) {
          ...
          <div className="space-y-1.5 xs:space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                step={1}
                placeholder="e.g., 30"
                className={`pl-8 xs:pl-9 sm:pl-10 md:pl-11 h-9 xs:h-10 sm:h-11 md:h-12 text-xs xs:text-sm md:text-base ${NO_SPINNER} ${
          ...
          {offersDelivery && (
            <div className="space-y-2.5 xs:space-y-3 sm:space-y-4 pt-2 border-t border-gray-200">
              <div className="flex flex-wrap items-center gap-1.5 xs:gap-2">
                <span className="text-xs font-bold text-gray-400 shrink-0">CAD</span>
                <h3 className="text-xs xs:text-sm sm:text-base md:text-lg font-semibold text-gray-900">
                  Delivery Settings
                </h3>
              ...
              <div className="grid md:grid-cols-2 gap-2.5 xs:gap-3 sm:gap-4">
                ...
                <div className="space-y-1.5 xs:space-y-2">
                  ...
                  <div className="relative">
                    <span className="absolute left-2.5 xs:left-3 top-1/2 -translate-y-1/2 text-[10px] xs:text-xs font-bold text-gray-400 leading-none">CAD</span>
                    <Input
                        id="deliveryFee"
                        type="number"
                        min={0}
                        step="0.01"
                        placeholder="5.00"
                        className={`pl-10 xs:pl-11 sm:pl-12 h-9 xs:h-10 sm:h-11 md:h-12 text-xs xs:text-sm md:text-base ${NO_SPINNER} ${
                ...
                <div className="space-y-1.5 xs:space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      step={1}
                      placeholder="45"
                      className={`pl-7 xs:pl-8 sm:pl-9 md:pl-10 h-9 xs:h-10 sm:h-11 md:h-12 text-xs xs:text-sm md:text-base ${NO_SPINNER} ${
