  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl space-y-4">
        ...
        {/* Success Card */}
        <Card className="shadow-xl border-emerald-100 overflow-hidden !bg-white">
          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex gap-4 p-4 bg-gray-50 rounded-lg border border-gray-100">
                  <div className="w-7 h-7 rounded-full bg-emerald-500 text-white flex items-center justify-center font-semibold text-xs shrink-0 mt-0.5">
                    1
                  </div>
                  <div>
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {[
                  ...
                  <div key={title} className="flex items-start gap-3">
                    <div className={`w-8 h-8 rounded-lg ${bg} border border-emerald-100 flex items-center justify-center shrink-0`}>
            ...
            <div className="flex flex-col-reverse sm:flex-row gap-3 pt-2">
              ...
              <Button
                ...
                className="flex-1 h-11 bg-emerald-500 hover:bg-emerald-600 text-white font-semibold transition-colors shadow-sm"
              >
