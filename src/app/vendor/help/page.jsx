    ...
    gettingStarted: [
        {
            ...
            answer: "Go to Profile in your dashboard sidebar. Fill in your store name, description, product type, address, and upload a logo and cover photo. A complete profile helps customers find and trust your store. Don't forget to set your operating hours so customers see accurate open/closed status.",
        },
        {
