...
export default function AboutPage() {
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            {/* Hero */}
            <div className="bg-gradient-to-r from-emerald-500 to-amber-600 text-white py-20 px-4">
            ...
            <div className="max-w-4xl mx-auto px-4 py-16 space-y-16">
                ...
                <section className="grid md:grid-cols-2 gap-10 items-center">
                    <div>
                        <span className="text-emerald-500 font-semibold text-sm uppercase tracking-widest">Our Story</span>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-gradient-to-br from-emerald-500 to-amber-600 rounded-2xl p-6 text-white flex flex-col justify-center">
                            <p className="text-4xl font-black mb-1">🌍</p>
                            <p className="font-bold text-lg">Pan-African</p>
                            <p className="text-emerald-100 text-xs mt-1">Cuisines from across the continent</p>
                        </div>
                        ...
                        <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-6 flex flex-col justify-center col-span-2">
                            <p className="text-2xl font-black text-emerald-600 mb-1">100% Authentic</p>
                ...
                <section>
                    <div className="text-center mb-10">
                        <span className="text-emerald-500 font-semibold text-sm uppercase tracking-widest">What We Stand For</span>
                ...
                {/* CTA */}
                <section className="bg-gradient-to-r from-emerald-500 to-amber-600 rounded-2xl p-10 text-white text-center">
                    <h2 className="text-2xl font-black mb-3">Ready to eat?</h2>
                    <p className="text-emerald-100 mb-6 text-sm">Browse African restaurants near you and order in minutes.</p>
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        <Link
                            href="/restaurants"
                            className="bg-white text-emerald-600 font-bold px-7 py-3 rounded-xl hover:bg-emerald-50 transition-colors text-sm"
                        >
                            Browse Restaurants
                        </Link>
                        <Link
                ...
                <section className="text-center">
                    <p className="text-slate-500 text-sm">
                        ...
                        <a href="mailto:support@afrochow.ca" className="text-emerald-600 hover:underline font-medium">
                            support@afrochow.ca
                        </a>
                    </p>
                </section>
