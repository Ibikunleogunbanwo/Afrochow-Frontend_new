                        ...
                        <div className="flex-1">
                            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4 gap-3">
                                ...
                                <div className="flex flex-col items-end gap-2 self-start shrink-0">
                                    {/* Open / Closed badge */}
                                    <div className={`px-3 py-1.5 rounded-full font-bold text-xs md:text-sm whitespace-nowrap ${
                                        isOpenNow
                                    ...
                                    <div className="flex items-center gap-2">
                                            ...
                                            {showShareMenu && (
                                                <div className="absolute right-0 mt-1 w-48 bg-white rounded-xl shadow-lg border border-gray-100 py-1 z-50">
                                                    ...
                                                    <a
                                                        ...
                                                        className="flex items-center gap-2.5 w-full px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
                                                    >
                                                        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.748l7.73-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                                                        X (Twitter)
                                                    </a>
                                                </div>
                                            )}
                                        ...
                                        <button
                                            ...
                                            title={isFavorited ? 'Remove from saved' : 'Save this restaurant'}
                                            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full border transition-colors text-sm font-semibold shadow-sm ${
                                                isFavorited
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-teal-600 mt-0.5">
                                                {preparationTime
                                                    ...
                                                    : 'Skip delivery and pick up your order when it is ready'}
                                            </p>
                                        </div>
                                    </div>
                                )}
