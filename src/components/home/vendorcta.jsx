...
// ── Vendor testimonial ────────────────────────────────────────────────────────
// Replace with a real vendor quote when available.
// Fields: initials, quote, name, storeAndLocation, rating (1–5)
const TESTIMONIAL = {
    initials:        "AO",
        ...
        <div className="container relative z-10 px-4 mx-auto max-w-7xl">
            ...
            <div className="grid gap-16 lg:grid-cols-2 items-center mb-20">
                ...
                <div className="relative">
                    {/* Contain blur orbs within this wrapper */}
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-gray-500">{TESTIMONIAL.storeAndLocation}</div>
                            </div>
                        </div>
                    </div>
                </div>
