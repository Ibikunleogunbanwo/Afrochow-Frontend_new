            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                {success ? (
                    <div className="text-center py-4">
                        <div className="w-16 h-16 bg-linear-to-br from-emerald-500 to-amber-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                        ...
                        <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-3 mb-4">
                            <p className="text-emerald-600 font-semibold text-sm break-all">{sentEmail}</p>
                        </div>

                        <div className="text-left bg-emerald-50 border border-emerald-200 rounded-xl p-4 mb-4">
                    ...
                    <>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 mt-2">
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        autoComplete="email"
                                        disabled={loading}
                                        className="w-full pl-10 pr-4 py-2.5 h-11 border border-slate-300 rounded-xl text-black bg-white focus:outline-none focus:ring-2 focus:ring-emerald-200 focus:border-emerald-500 transition-all text-sm"
                                    />
                                </div>
                            ...
                            <button
                                type="button"
                                onClick={onSignInClick || handleClose}
                                className="flex items-center justify-center gap-2 w-full text-sm text-slate-600 hover:text-emerald-600 font-medium transition-colors"
                            >
